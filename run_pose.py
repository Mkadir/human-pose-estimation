...
def set_position(file_name: str):
    dataset = 'COCO'
    ...
    inWidth = 368
    inHeight = 368
    protoFile = "deploy_coco.prototxt"
    weightsFile = "coco.caffemodel"
    net = cv.dnn.readNetFromCaffe(protoFile, weightsFile)
    frame = cv.imread(filename=file_name)
    ...
    return cv.imwrite('result_'+file_name,frame)


print(set_position(file_name='sh3.jpg'))
